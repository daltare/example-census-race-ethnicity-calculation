...
This section uses the [biscale](https://chris-prener.github.io/biscale/) R package [@biscale] to create bivariate choropleth maps that show how two variables vary together spatially.
