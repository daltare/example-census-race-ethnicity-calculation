...
And we can save the intermediate data from the interpolation process (i.e., data for clipped block groups) in wide and long format – these files can be downloaded with [this link](https://github.com/daltare/example-census-race-ethnicity-calculation/raw/main/03_data_results/intermediate_interpolation_data.csv) and [this link](https://github.com/daltare/example-census-race-ethnicity-calculation/raw/main/03_data_results/intermediate_interpolation_data_long.csv) respectively.
